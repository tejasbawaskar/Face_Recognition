...
# introspecting the images arrays to find the shapes
...
###############################################################################
# Computing PCA (eigenfaces) on the face dataset
n_components = 150
...
# plotting the result of the prediction on a portion of the test set
